    ...
    <div className="flex flex-col gap-24 pb-24 pt-32">
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
        ...
        >
          ...
          <p className="text-2xl font-bold text-gray-700 max-w-3xl mx-auto border-4 border-gray-900 p-6 shadow-[6px_6px_0px_0px_rgba(17,24,39,1)] bg-yellow-300 transform rotate-1">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="relative">
          ...
          <div className="absolute left-1/2 top-0 bottom-0 w-1.5 bg-gradient-to-b from-gray-300 via-gray-300 to-[var(--color-purple-slice)] -translate-x-1/2 rounded-full shadow-inner" />
          ...
          <div className="space-y-16">
            ...
            >
              ...
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-white rounded-full border-4 border-gray-200 shadow-md flex items-center justify-center z-10 hover:scale-110 transition-transform">
            ...
            <motion.div 
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true, margin: "-100px" }}
              className="flex items-center justify-between gap-12 relative flex-row-reverse"
            >
            ...
            >
              ...
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-white rounded-full border-4 border-red-200 shadow-md flex items-center justify-center z-10 hover:scale-110 transition-transform">
      ...
      <section className="bg-gray-900 py-32 rounded-[3rem] text-white my-12 relative overflow-hidden border-4 border-gray-900 shadow-[0_20px_50px_rgba(191,0,255,0.2)] mx-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center mb-20 mt-10">
          <h2 className="text-6xl md:text-8xl font-space-grotesk font-black mb-10 uppercase tracking-tighter text-[var(--color-purple-slice)] drop-shadow-[4px_4px_0_rgba(17,24,39,1)]">
            The Slice Solution
          </h2>
          <p className="text-2xl text-gray-900 font-black border-4 border-gray-900 inline-block px-8 py-4 bg-[#10B981] -rotate-1 shadow-[6px_6px_0px_0px_rgba(17,24,39,1)] uppercase tracking-tight">
